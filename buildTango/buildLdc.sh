...
$TANGO_HOME/build/bin/linux64/bob -u -c=ldc -p=linux -l=libtango-user-ldc-tst -o="-d -version=UnitTest -debug=UnitTest -unittest -g -debug -L-ltango-dbg"  $TANGO_HOME
rm *.o
dirldc="`which ldc`"
...
ldc -d -version=UnitTest -debug=UnitTest -unittest -g -debug -L-ltango-user-ldc-tst -L-lz -L-lbz2 runUnittests_ldc.d
rm *.o
