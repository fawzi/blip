...
$TANGO_HOME/build/bin/osx32/bob -r=dmd -c=dmd -p=osx -l=libtango-base-dmd -o="-O -release -inline"  $TANGO_HOME
$TANGO_HOME/build/bin/osx32/bob -u -c=dmd -p=osx -l=libtango-user-dmd -o="-g -O -release -inline"  $TANGO_HOME
