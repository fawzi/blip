...
TESTS=testRpc EchoServer StressEchoServer testBlip testSerial testTextParsing testRTest testNArrayPerf testNuma testHwloc testSmp testNArray testLibev Fibonacci Gauss
