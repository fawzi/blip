...
class IOArray : Conduit, InputBuffer, OutputBuffer, Conduit.Seek
{
        ...
        ***********************************************************************/
        ...
        this (void[] data, size_t readable, size_t growing=0)
        {
                assign (data, readable,growing);
        }
        ...
        ***********************************************************************/
        ...
        IOArray assign (void[] data, size_t readable, size_t growing=0)
        {
                this.data = data;
