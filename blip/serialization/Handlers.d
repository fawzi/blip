...
string coreTypeDelegates(string constStr="const",string indent="    "){
    string res="";
    foreach (T;CoreTypes){
        res~=indent~"void delegate(ref "~constStr~" "~T.stringof~" el) coreHandler_"~strForCoreType!(T)~";\n";
    }
    return res;
}
...
class CoreHandlers(string constStr){
    this(){}
    
    mixin(coreTypeDelegates(constStr));
...
class WriteHandlers: CoreHandlers!("const"),OutStreamI{
    ...
    void rawWrite(in void[] data){
        assert(0,"unimplemented");
    }
    /// writes a raw string
    void rawWriteStrC(in cstring data){
        assert(0,"unimplemented");
    }
    void rawWriteStrW(in cstringw data){
        assert(0,"unimplemented");
    }
    void rawWriteStrD(in cstringd data){
        assert(0,"unimplemented");
    }
    //alias rawWriteStrC rawWriteStr;
    //alias rawWriteStrW rawWriteStr;
    //alias rawWriteStrD rawWriteStr;
    void rawWriteStr(in cstring data){
        assert(0,"unimplemented");
    }
    void rawWriteStr(in cstringw data){
        assert(0,"unimplemented");
    }
    void rawWriteStr(in cstringd data){
        assert(0,"unimplemented");
    }
    ...
    CharSink charSink(){
        return cast(void delegate(in cstring))&this.rawWriteStr;
    }
    BinSink binSink(){
...
class ReadHandlers: CoreHandlers!(""){
    ...
    bool skipString(in cstring str,bool shouldThrow){
...
final class BinaryWriteHandlers(bool SwapBytes=isSmallEndian):WriteHandlers{
    void delegate(in void[]) writer;
    void delegate() _close;
    
    this (string dsc,void delegate(in void[]) writer, void delegate() flusher=null, void delegate() _close=null,OutWriter dscW=null)
    {
    ...
    this (OutWriter dsc,void delegate(in void[]) writer, void delegate() flusher=null, void delegate() _close=null){
...
class FormattedWriteHandlers(U=char): WriteHandlers{
    ...
    this(string dsc,void delegate(in U[]) writer,void delegate() flusher=null,void delegate() _close=null,OutWriter dscW=null){
        super(dsc,flusher,dscW);
        this.writer=writer;
        this._close=_close;
        setCoreHandlersFrom_basicWrite();
    }
    this(OutWriter dsc,void delegate(in U[]) writer,void delegate() flusher=null,void delegate() _close=null){
        super(dsc,flusher);
        this.writer=writer;
        this._close=_close;
        setCoreHandlersFrom_basicWrite();
    ...
    override void rawWriteStrW(in cstringw s){
        writeStr(s);
    }
    override void rawWriteStrD(in cstringd s){
        writeStr(s);
    }
    //alias rawWriteStrC rawWriteStr;
    //alias rawWriteStrW rawWriteStr;
    //alias rawWriteStrD rawWriteStr;
    override void rawWriteStr(in cstring s){
        writeStr(s);
    }
    override void rawWriteStr(in cstringw s){
        writeStr(s);
    }
    override void rawWriteStr(in cstringd s){
        writeStr(s);
    }
    CharSink charSink(){
        static if (is(U==char)){
...
final class FormattedReadHandlers(T):ReadHandlers{
    ...
    T[] rawReadStr(size_t amount){
        return cast(T[])reader.readNCodePoints(amount);
    }
