...
/+    extern(C){
    ...
    // arpa/inet.h
    // print ip addresses
    public import core.sys.posix.arpa.inet: inet_ntop, inet_pton;
    
    // select
    public import core.stdc.sys.posix.sys.select: fd_set,select,FD_ZERO,FD_SET,FD_ISSET;

    // netdb.h
    public import core.sys.posix.netdb;

    public import core.sys.posix.unistd: read, write, close;
